...
import static com.rocketmq.remoting.common.RemotingUtil.closeChannel;

/**
 * @author xuleyan
 * @version NettyRemotingClient.java, v 0.1 2020-11-01 9:28 下午
 */
@Slf4j
public class NettyRemotingClient extends NettyRemotingAbstract implements RemotingClient {
    ...
    public NettyRemotingClient(final NettyClientConfig nettyClientConfig, final ChannelEventListener channelEventListener) {
        ...
        this.publicExecutor = new ThreadPoolExecutor(
                publicThreadNums, publicThreadNums, 0L, TimeUnit.MILLISECONDS,
    ...
    private RemotingCommand invokeSyncImpl(final Channel channel, final RemotingCommand request, final long timeoutMillis)
