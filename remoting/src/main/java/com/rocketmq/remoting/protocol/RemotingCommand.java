...
/**
 * @author xuleyan
 * @version RemotingCommand.java, v 0.1 2020-10-10 10:50 上午
 */
public class RemotingCommand {
    ...
    private static final Map<Field, Annotation> NOT_NULL_ANNOTATION_CACHE = new HashMap<>();
    ...
    private static RemotingCommand createResponseCommand(int code, String remark, Class<? extends CommandCustomHeader> classHeader) {
